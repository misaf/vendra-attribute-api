...
#[ApiResource(
    shortName: 'Attribute',
    stateOptions: new Options(modelClass: Attribute::class, handleLinks: AttributeResourceProvider::class),
    mcp: [
...
#[Get(uriTemplate: '/catalog/attributes/{id}', provider: AttributeResourceProvider::class)]
#[GetCollection(
